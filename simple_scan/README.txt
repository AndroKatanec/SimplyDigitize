...
Cijeli github simple_scan je catkin workspace u kojem pri downloadanju treba prelagoditi package.xml s obzirom na host-a.
...
4) Pokrenuti roscore
5) Pozicionirati bash u /simple_scan/scripts folder
6) Iskoristiti komandu: "rosrun simple_scan finish_listener.py"
7) 
