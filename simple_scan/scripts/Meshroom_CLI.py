...
def featureMatching(binPath,baseDir,numberOfImages,imagesPerGroup=40):
    ...
    method = "ANN_L2"  #    Feature matching method
...
def meshing(binPath, baseDir, maxInputPoints = 10000000, maxPoints=1000000):
...
def texturing(binPath, baseDir, textureSide = 4096 , downscale=2, unwrapMethod = "Basic"):
    ...
    cmdLine += f" --outputTextureFileType png"
    os.system(cmdLine)
...
def __run__(binPath,baseDir,imgDir):
    ...
    texturing(binPath, baseDir, downscale=2)
