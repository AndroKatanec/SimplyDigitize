...
Cijeli github simply_digitize je catkin workspace u kojem pri downloadanju treba prelagoditi package.xml s obzirom na host-a.
...
4) Pokrenuti roscore
5) Pozicionirati bash u /simply_digitize/scripts folder
6) Iskoristiti komandu: "rosrun simply_digitize finish_listener.py"
7) 
